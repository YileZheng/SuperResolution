...
generator_upconv.load_state_dict(torch.load("saved_models/inference/generator_upconv.pth"))

generator_upconv.eval()

generator_upsamp = Generator_Anti_Artifact(channels=3, filters=64, num_res_blocks=23).to(device)

generator_upsamp.load_state_dict(torch.load("saved_models/inference/generator_upsamp.pth"))
