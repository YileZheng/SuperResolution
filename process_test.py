...
generator_upconv.load_state_dict(torch.load("weights/sr/generator_upconv.pth"))

generator_upconv.eval()

generator_upsamp = Generator_Anti_Artifact(channels=3, filters=64, num_res_blocks=23).to(device)

generator_upsamp.load_state_dict(torch.load("weights/sr/generator_upsamp.pth"))
...
generator_upsamp_nn.load_state_dict(torch.load("weights/sr/generator_upsamp_nn.pth"))
...
# img = cv2.imread("images\\training\\0008200.png")
# # img = cv2.imread("images\\inference\\000548_0.png")
